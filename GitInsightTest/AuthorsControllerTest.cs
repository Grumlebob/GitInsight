...
public class AuthorsControllerTest : IDisposable
{
    ...
    public async Task UpdateAuthorReturnsOk()
    {
        ...
        var updatedAuthors = await _authorsController.UpdateAuthor(new AuthorUpdateDto(updatedAuthor.Id,
            updatedAuthor.Name, updatedAuthor.Email, new List<int>()));
    ...
    public async Task UpdateAuthorReturnsNotFound()
    {
        ...
        var updatedAuthors =
            await _authorsController.UpdateAuthor(new AuthorUpdateDto(author.Id, author.Name, author.Email,
                new List<int>()));
